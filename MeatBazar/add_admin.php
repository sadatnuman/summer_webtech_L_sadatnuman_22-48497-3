...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkUserSql = "SELECT user_name FROM admin WHERE user_name = ?";
    ...
    // Insert new admin
    $sql = "INSERT INTO admin (full_name, email, user_name, phone_number, dob, password) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="form-container">
                ...
                <form onsubmit="return validateRegister()" method="POST" action="add_admin.php">
                    ...
                    <button type="submit" class="btn btn-create">Create Admin Account</button>
                </form>
                <button type="button" class="btn btn-back" onclick="window.location='manage_admin.php'">Back</button>
            </div>
        </div>
    </div>
    <script>
