...
try {
    $distributor_username = $_SESSION['user_name'];
    $sql = "SELECT * FROM orders WHERE assigned_distributor = ? ORDER BY created_at DESC";

    $stmt = $conn->prepare($sql);
    $stmt->bind_param("s", $distributor_username);
...
<head>
    <meta charset="UTF-8">
    <title>My Assigned Orders - Meat Bazar Distributor</title>
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="orders-container">
                <h2 class="page-title">My Assigned Orders</h2>
                ...
                <div class="orders-table">
                    <div class="table-header">
                        <i class="fa fa-shopping-cart"></i> Manage Assigned Orders
                    </div>
