...
<head>
    <meta charset="UTF-8">
    <title>Chicken - Meat Bazar</title>
    ...
    <style>
        ...
        * {
        ...
        /* Additional styles for chicken products */
        .products-grid {
            display: grid;
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <h2>Fresh Chicken Products</h2>
            <div class="products-grid">
                <?php
                require_once "db.php";
                $products = [];
                $stmt = $conn->prepare("SELECT * FROM inventory WHERE category='chicken' ORDER BY id DESC");
                $stmt->execute();
