...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <h2>Fresh Beef Products</h2>
            <div class="products-grid">
                <?php
                require_once "db.php";
                $products = [];
                $stmt = $conn->prepare("SELECT * FROM inventory WHERE category='beef' ORDER BY id DESC");
                $stmt->execute();
    ...
    <script>
        ...
        if (typeof(Storage) !== "undefined") {
            sessionStorage.setItem("currentPage", "beef.php");
        }
