...
<head>
    <meta charset="UTF-8">
    <title>Distributor Profile - Meat Bazar</title>
            ...
            <div class="profile-container">
                ...
                <?php if ($distributor): ?>
                    <div class="profile-field">
                        ...
                        <input type="text" value="<?php echo htmlspecialchars($distributor['full_name']); ?>" readonly>
                    </div>
                    <div class="profile-field">
                        <label>Email</label>
                        <input type="text" value="<?php echo htmlspecialchars($distributor['email']); ?>" readonly>
                    </div>
                    <div class="profile-field">
                        <label>Username</label>
                        <input type="text" value="<?php echo htmlspecialchars($distributor['user_name']); ?>" readonly>
                    </div>
                    <div class="profile-field">
                        <label>Phone Number</label>
                        <input type="text" value="<?php echo htmlspecialchars($distributor['phone_number']); ?>" readonly>
                    </div>
                    <div class="profile-field">
                        <label>Date of Birth</label>
                        <input type="text" value="<?php echo htmlspecialchars($distributor['dob']); ?>" readonly>
                    </div>
                    <div class="profile-field">
                        <label>Password</label>
                        <div class="password-wrapper">
                            <input type="password" id="password" value="<?php echo htmlspecialchars($distributor['password']); ?>" readonly>
                            <button type="button" onclick="togglePassword()" title="Show/Hide">👁</button>
                        </div>
                    </div>
                <?php else: ?>
                    <p>No distributor data found.</p>
                <?php endif; ?>
