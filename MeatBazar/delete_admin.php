...
// Handle admin deletion by username
if (isset($_POST['delete_username']) && !empty($_POST['delete_username'])) {
    ...
    $sql = "DELETE FROM admin WHERE user_name = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("s", $username);

    if ($stmt->execute()) {
        echo "<script>alert('✅ Admin deleted successfully!'); window.location='delete_admin.php';</script>";
    } else {
        echo "<script>alert('❌ Error deleting admin.'); window.location='delete_admin.php';</script>";
    }
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="delete_admin.php" style="display:inline;">
                                    <input type="hidden" name="delete_username" value="<?php echo $admin['user_name']; ?>">
            ...
            <div class="btn-row">
                <a href="manage_admin.php" class="black-btn">Back</a>
            </div>
        </div>
    </div>
</body>
