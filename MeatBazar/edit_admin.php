...
// Handle admin update by username
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE admin SET full_name = ?, phone_number = ?, dob = ? WHERE user_name = ?";
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="" style="display:inline;">
                                    <input type="hidden" name="edit_username" value="<?php echo $admin['user_name']; ?>">
