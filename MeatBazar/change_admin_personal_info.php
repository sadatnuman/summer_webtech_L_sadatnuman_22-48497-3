...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sqlU = "UPDATE admin SET full_name = ?, phone_number = ?, dob = ?, password = ? WHERE user_name = ?";
...
<head>
    <meta charset="UTF-8">
    <title>Change Admin Personal Info - Meat Bazar</title>
            ...
            <div class="profile-container">
                ...
                <form method="post" action="">
                    <div class="profile-field">
                        ...
                        <div class="field-row">
                            <input type="text" id="full_name" name="full_name" value="<?php echo htmlspecialchars($admin['full_name']); ?>" placeholder="Enter full name" readonly>
                    ...
                    <div class="profile-field">
                        <label>Email</label>
                        <div class="field-row">
                            <input type="email" id="email" value="<?php echo htmlspecialchars($admin['email']); ?>" placeholder="Email" readonly>
                    ...
                    <div class="profile-field">
                        ...
                        <div class="field-row">
                            <input type="text" id="user_name" value="<?php echo htmlspecialchars($admin['user_name']); ?>" placeholder="Username" readonly>
                            <button type="button" class="edit-btn" disabled>Edit</button>
                        </div>
                    ...
                    <div class="profile-field">
                        ...
                        <div class="field-row">
                            <input type="text" id="phone_number" name="phone_number" value="<?php echo htmlspecialchars($admin['phone_number']); ?>" placeholder="Enter phone number" readonly>
                    ...
                    <div class="profile-field">
                        ...
                        <div class="field-row">
                            <input type="date" id="dob" name="dob" value="<?php echo htmlspecialchars($admin['dob']); ?>" placeholder="YYYY-MM-DD" readonly>
                    ...
                    <div class="profile-field">
                        ...
                        <div class="field-row">
                            <input type="password" id="password" name="password" value="<?php echo htmlspecialchars($admin['password']); ?>" placeholder="Enter new password" readonly>
