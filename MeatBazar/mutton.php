...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Additional styles for mutton products */
        .products-grid {
            display: grid;
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <h2>Fresh Mutton Products</h2>
            <div class="products-grid">
                <?php
                require_once "db.php";
                $products = [];
                $stmt = $conn->prepare("SELECT * FROM inventory WHERE category='mutton' ORDER BY id DESC");
                $stmt->execute();
