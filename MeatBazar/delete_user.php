...
// Handle user deletion by username
if (isset($_POST['delete_username']) && !empty($_POST['delete_username'])) {
    ...
    $sql = "DELETE FROM registration WHERE user_name = ?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("s", $username);

    if ($stmt->execute()) {
        echo "<script>alert('✅ User deleted successfully!'); window.location='delete_user.php';</script>";
    } else {
        echo "<script>alert('❌ Error deleting user.'); window.location='delete_user.php';</script>";
    }
...
<head>
    <meta charset="UTF-8">
    <title>Manage Users - Meat Bazar</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="delete_user.php" style="display:inline;">
                                    <input type="hidden" name="delete_username" value="<?php echo $user['user_name']; ?>">
            ...
            <div class="btn-row">
                <a href="manage_user.php" class="black-btn">Back</a>
            </div>
        </div>
    </div>
</body>
